...
How to handle dynamic web elements?
    1- First I would try to locate one of the static parents or children if there are any. And then I would locate the desired web element from there.
