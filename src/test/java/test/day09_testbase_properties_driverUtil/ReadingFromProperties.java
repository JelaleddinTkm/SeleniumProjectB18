...
public class ReadingFromProperties {
    ...
    public void reading_properties_file() throws IOException {
        ...
        String path = "configuration.properties";   // Path From Content Root

        //Absolute Path: /Users/bayramgeldipirjanov/Desktop/SeleniumProjectB18/configuration.properties
