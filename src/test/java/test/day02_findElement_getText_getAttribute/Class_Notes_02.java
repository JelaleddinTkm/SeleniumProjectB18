...
3- partialLinkText:
	...
	--> this locator allows us to locate LINKS by their texts, BUT it does not expect the whole text to be passed. Only check if the given text is contained in the link
