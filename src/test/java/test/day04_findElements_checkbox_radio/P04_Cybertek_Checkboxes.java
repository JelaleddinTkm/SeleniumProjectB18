...
public class P04_Cybertek_Checkboxes {
    ...
    public static void main(String[] args) {
        ...
        Checkbox 1 is not selected. Verification PASSED!
        Checkbox 2 is selected by default. Verification PASSED!
        Checkbox 1 is selected. Verification PASSED!
        Checkbox 2 is NOT selected. Verification PASSED!
